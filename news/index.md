...
- Added extensive additional test coverage for data type validation and
  error handling.
...
- Improved validity checks for covariance elements of `bl` objects to
  ensure they are positive definite and that we have coverage for
  scalars.
